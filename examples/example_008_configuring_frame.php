<?php
    ...
    QRcode::png($codeContents, $tempDir.'008_4.png', QRconst::QR_ECLEVEL_L, 3, 4);
    QRcode::png($codeContents, $tempDir.'008_6.png', QRconst::QR_ECLEVEL_L, 3, 6);
    QRcode::png($codeContents, $tempDir.'008_12.png', QRconst::QR_ECLEVEL_L, 3, 10);
